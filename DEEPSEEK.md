...
> **DeepSeek (Ollama):** Run `deepseek` from this directory — auto-loads this file. This file is loaded automatically. Check `docs/next-session.md` for current priorities.
